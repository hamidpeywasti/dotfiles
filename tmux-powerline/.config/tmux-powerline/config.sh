...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="38.08"
	TMUX_POWERLINE_SEG_AIR_LON="46.2919"
	# Your Open Weather API Key:
	TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY="bc917f80092840cd84019e1e342e4f38"
# }
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/hamid/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/hamid"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/hamid/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/hamid/.now_playing.log"
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="38.08"
	TMUX_POWERLINE_SEG_WEATHER_LON="46.2919"
# }
